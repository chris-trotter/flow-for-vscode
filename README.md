...
## Configuration
You can amend your configuration settings by amending the VS Code `settings.json` file. You must reload VS Code after installing this extension for these settings to take affect.
